...
import { shippingVehicleViewColumn, wagonColumn } from '../../lib/columns'
                        ...
                        shipment.subShipping.map((shipment, index) => {
                            return (
                                <div className="py-4" key={index}>
                                    ...
                                    {shipment.vehicles[0].type === 'train' && (
                                        <div className="my-4">
                                        <h4 className="text-2xl font-medium mb-2">Wagons Attached to Train</h4>
                                        <p className="py-2 text-lg font-medium">Total number of wagons: {shipment.wagons.length}</p>
                                        <DataTable columns={wagonColumn} data={shipment.wagons}/>
                                        </div>
                                    )}
                                </div>
                            )
