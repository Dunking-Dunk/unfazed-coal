...
import { shippingVehicleFormColumn, shippingWagonColumn, wagonColumn } from "../../lib/columns";
...
const ShipmentFormMap = ({ index, setSubShipment, subShipment, startDate }) => {
    ...
    const { trains, trucks, ships, wagons } = useSelector((state) => state.Vehicle)
    ...
    const [shipmentWagons, setShipmentWagons] = useState([])
                    ...
                    }
                    {
                        shipment.length > 1 && (
                            <div className="space-y-2">
                                ...
                                {vehiclesForm.length > 0 && vehiclesForm[0].type === 'train' && (
                                    <>                                  
                                     <h3 className="text-2xl mb-2 font-bold">Select Wagons for Train</h3>
                                     <Table columns={shippingWagonColumn} data={wagons} getSelectedRow={setShipmentWagons}/>
                                    </>
                                )}
                            </div>
                        )
